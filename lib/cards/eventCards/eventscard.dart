...
import 'package:blackhouse/cards/eventCards/eventscard_model.dart';

//继承事件父类
class EventsCard extends EventModel with BaseComponent{

  EventsCard(BlackHouseGame game,Sprite cardSprite,Offset position,int  cardid)
