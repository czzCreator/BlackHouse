...
import 'dart:math';
import 'dart:ui';
import 'package:blackhouse/cards/omensCards/omenscard_model.dart';
...
//继承事件父类
class OmensCard extends OmenModel with BaseComponent{
  OmensCard(BlackHouseGame game,Sprite cardSprite,Offset position,int  cardid)
